...
public class ProxySocket{
	...
	public static void main(String[] args) throws IOException{
		...
		System.out.println("wait for config string...");
                ...
                //set proxyConfigSocket timeout
                try {
                        proxyConfigSocket.setSoTimeout(60000);
                }
                catch (SocketException e){
                        System.out.println("SocketException when set proxyConfigSocket timeout.");
		...
		boolean first_client = true;
                ...
                //set proxySocket timeout
                try {
                        proxySocket.setSoTimeout(60000);
                }
                catch (SocketException e){
                        System.out.println("SocketException when set socket timeout.");
                        System.out.println(e.getMessage());
                        proxySocket.close();
                        System.exit(1);        
                }
			...
			while(true){
				...
				try {
					...
					clientSocket.close();
                        ...
                        System.out.println("the proxy server time out and exit.");
                        System.out.println(e.getMessage());
                } 
                catch (IOException e) {
		            System.out.println("Exception caught when trying to listen on port "
