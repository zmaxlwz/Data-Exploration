...
if (!$dbconn) {
  ...
  <head>
	...
	function changeQuery(query_select){
		...
		if(query == "query 1" || query == "query 3"){
			//set attribute for query 1 and query 3
			//console.log("here");
        ...
        <div class="col-md-12">
          ...
          <form class="" action="histogram2.php" method="post">
			...
			"</div>";
			  ...
			  elseif($_SESSION["scenario"] == "Scenario 5"){
	              echo "<div class='col-md-12 medium-top-margin medium-bottom-margin'>" .
					  "<div class='form-group'>".
	                  "<label for='' class='col-md-1 control-label'>Query :</label>".
	                      "<div class='col-md-3'>".
	                        "<select name = 'target_query' class='form-control' id='target_query_id'>".
	                             "<option value='query 1'>query 1\n</option>;".
	                             "<option value='query 2'>query 2\n</option>;".
	                        "</select>".
	                      "</div>".
                  ...
                  <div class="panel-body enable-scroll">
                    ...
                    elseif($_SESSION["tblname"] == "sdss_random_sample"){
	                    ...
	                    while ($line = pg_fetch_array($result, null, PGSQL_NUM)) {
						  ...
						  if($_SESSION["scenario"] == "Scenario 4" || $_SESSION["scenario"] == "Scenario 5"){
