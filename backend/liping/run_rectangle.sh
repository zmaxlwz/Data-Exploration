...
java -Xmx1024M -cp $CLASSPATH execute.RunDemoSocket 8889 backEndConfigRect.json  
#java -Xmx4196M -cp $CLASSPATH execute.RunDemoSocket 8889 backEndConfigRect.json  
