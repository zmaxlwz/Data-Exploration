...
public class RandomEvictionsBuffer extends Buffer
{
	...
	void removeEntry()
	{
		...
		long l_id = ((Long) me.getKey()).longValue();

		if (e.m_bDirty)
		{
			m_storageManager.storeByteArray(l_id, e.m_data);
		}

		m_buffer.remove(new Long(l_id));
	}
