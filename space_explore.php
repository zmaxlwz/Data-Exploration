        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="col-md-9">
				...
				<div class="col-md-12" id='zoom-in-part'>
						...
						<div class="col-md-5">							  	
                    	  	<div class="form-group">
                      			<div class="input-group">
                        			...
                        			<input type='text' class='form-control' id='zoomin-x-minvalue' placeholder=''>
                        			<div class="input-group-addon">X &nbsp; Max</div>
                        			<input type='text' class='form-control' id='zoomin-x-maxvalue' placeholder=''>
                      	  		</div>
                    	  	</div>		
						</div>
						<div class="col-md-5">
                        	<div class="form-group">
                          		<div class="input-group">
                            		...
                            		<input type='text' class='form-control' id='zoomin-y-minvalue' placeholder=''>
                            		<div class="input-group-addon">Y &nbsp; Max</div>
                            		<input type='text' class='form-control' id='zoomin-y-maxvalue' placeholder=''>
                          	  	</div>
                        	</div>
						</div>
						<div class="col-md-2 btn-group-vertical">
                    		<button type='button' class='btn btn-default' id='zoom-in-btn'>Zoom in</button>
							<button type='button' class='btn btn-default' id='goback-btn'>Restore</button>
						</div>
...
// 						}
						...
						if($_SESSION["tblname"] == "real_estate"){
							echo "<button type='button' class='btn btn-default' id='all-relevant-objects-btn' onclick='all_relevant_objects_btn_clicked()'>All Relevant Objects</button>";
						}
                        ?>
                ...
                <ul class="list-group bottom-align" id='list-of-nums'>
                  ...
                  <li class="list-group-item">
                    <span class="badge" id="list_num_labeled">0</span>
                    Labeled Samples
                  </li>			
