          ...
          <div class="col-md-12">
           <?php
			  if($_SESSION["scenario"] != "Scenario 2"){
                ...
                "</form>".
				"<script type='text/javascript'>var count = 0; $('input:checkbox').change(function() {if (this.checked) {count += 1;} else {count -= 1;}var btn=document.getElementById('automatic'); if(count > 0) {btn.disabled=false; } else{btn.disabled=true;}}); </script>";
            ...
            <form target="_blank" action="space_explore_manual.php" method="post">
			  ...
			  if($_SESSION["tblname"] == "real_estate" && $_SESSION["scenario"] == "Scenario 2"){
				  ...
				  echo "<button type='submit' name='attr_confirm' class='btn btn-primary button-align' id='manual' disabled='disabled'>Manual</button>\n".
				"<script type='text/javascript'>var count = 0; $('input:checkbox').change(function() {if (this.checked) {count += 1;} else {count -= 1;}var btn=document.getElementById('manual'); if(count > 0) {btn.disabled=false; } else{btn.disabled=true;}}); </script>";
